...
from app.routers import ai, analytics, auth, categories, favorites, gifts, ingestion, metrics, users
...
def create_app() -> FastAPI:
    ...
    app.include_router(metrics.router, prefix="/admin/metrics", tags=["metrics"])
